...
public class RetainFrameHorizontalRender extends BaseRender {
    ...
    public RetainFrameHorizontalRender(Context context) {
        super(
                context,
                "render/other/retain_frame_horizontal/vertex.frag",
                "render/other/retain_frame_horizontal/frag.frag"
        );
