...
public class FlipVerticalTransition extends BaseTransition {
    private int uCompressLocation;
    private int uUseSamplerLocation;

    public FlipVerticalTransition(Context context) {
        super(
                context,
                "render/transition/flip_vertical/vertex.frag",
                "render/transition/flip_vertical/frag.frag"
        );
    }
