package com.yk.media.opengles.render.transition2.base;
...
public class BaseTransition extends BaseRender {
    ...
    public BaseTransition(Context context) {
        super(
                context,
                "render/transition2/base/vertex.frag",
                "render/transition2/base/frag.frag"
        );
    }
    ...
    public void onInitLocation() {
        ...
        uProgressLocation = GLES20.glGetUniformLocation(getProgram(), "uProgress");
    }
