...
public class TransitionListView extends FrameLayout {
    ...
    public TransitionListView(@NonNull Context context) {
        this(context, null);
    }

    public TransitionListView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TransitionListView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initData() {
        list = TransitionUtils.TRANSITION_LIST;
